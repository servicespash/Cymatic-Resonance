...
export function CallContainer({
  ...
  // Call clock — only count when connected (recipient answered)
  useEffect(() => {
...
function StageTile({
  ...
  return (
    <div className="relative size-full flex items-center justify-center overflow-hidden">
      ...
      {/* Visual Mute Indicator Overlay */}
      {isMuted && (
        <div className="absolute top-4 right-4 z-30 flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-destructive/80 text-destructive-foreground backdrop-blur-md border border-destructive/30 text-xs font-bold shadow-lg animate-pulse">
          <MicOff className="size-4" /> Muted
        </div>
      )}
      ...
      <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between rounded-2xl bg-black/80 px-4 py-2.5 backdrop-blur-xl border border-white/10 z-20">
        ...
        <div className="flex items-center gap-2">
          {isMuted && <MicOff className="size-4 text-destructive" />}
          {isHandRaised && (
...
function ThumbnailTile({
  ...
  return (
    ...
    >
      ...
      {isMuted && (
        <div className="absolute top-2 right-2 z-20 size-6 rounded-full bg-destructive/80 text-destructive-foreground grid place-items-center shadow-md">
      ...
      <div className="absolute bottom-2 left-2 right-2 flex items-center justify-between rounded-lg bg-black/80 px-2 py-1 backdrop-blur-md border border-white/5">
        ...
        {isMuted && <MicOff className="size-3 text-destructive" />}
...
function GridTile({
  ...
  return (
    ...
    >
      ...
      {isMuted && (
        <div className="absolute top-3 right-3 z-20 px-2.5 py-1 rounded-xl bg-destructive/80 text-destructive-foreground flex items-center gap-1 text-xs font-bold shadow-md">
      ...
      <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between rounded-xl bg-black/80 px-3 py-1.5 backdrop-blur-md border border-white/10">
        ...
        <div className="flex items-center gap-1.5">
          {isMuted && <MicOff className="size-3.5 text-destructive" />}
