  ...
  return (
    <section className="glass rounded-2xl p-6">
      ...
      <p className="mt-1 text-xs text-muted-foreground">
        Generate a private link to share via your own email or chat. Valid for 14 days.
      </p>
      ...
      <div className="mt-4 grid gap-2 sm:grid-cols-[1.4fr_1fr_0.8fr_auto]">
        ...
        <select
          ...
          className="rounded-md border border-white/10 bg-white/5 px-3 text-sm"
        >
      ...
      <div className="mt-5 divide-y divide-white/5">
        ...
        {list.map((inv, idx) => {
          ...
          return (
            <div key={`${inv.id}-${idx}`} className="flex items-center justify-between py-3">
              <div className="min-w-0">
                <div className="truncate text-sm font-medium">{inv.email}</div>
                <div className="font-mono text-[10px] uppercase tracking-widest text-muted-foreground">
                  {inv.role} {inv.category ? `· ${inv.category}` : ""} ·{" "}
                  {accepted ? (
              ...
              <div className="flex items-center gap-1.5">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1 rounded-md border border-white/10 bg-white/5 px-2.5 py-1.5 text-xs text-red-300 hover:bg-red-500/10"
                >
